...
Static_Array_Menu::Static_Array_Menu(Event* event, RenderWindow* window)
{
	...
	// Instruction
	{
		...
		Instruction[3] = "Make an Static Array with inputed values (for creating a Array with size 1 please use ADD function)";
		Instruction[4] = "Make an Static Array with size and value imported from data file";

		Instruction[5] = "Add to the First of the Static Array";
		Instruction[6] = "Add to the Last of the Static Array";
		Instruction[7] = "Add to the inputed position of the Static Array (position larger than size will be understood as max size)";

		Instruction[8] = "Delete at the First of the Static Array";
		Instruction[9] = "Delete at the Last of the Static Array";
		Instruction[10] = "Delete at inputed position of the Static Array (position larger than size will be understood as max size)";
...
void Static_Array_Menu::update(const Vector2f mousePos)
{
	...
	if (Toggle_Group_Static_Array.checkEmpty()) curInsId = 13;
