...
Static_Array_Menu::Static_Array_Menu(Event* event, RenderWindow* window)
{
	...
	Toggle_Group_Linked_List.Toggle_Btn_Grp[0] = tog_Initialize;	
	Toggle_Group_Linked_List.Toggle_Btn_Grp[1] = tog_Update;	Toggle_Group_Linked_List.Toggle_Btn_Grp[2] = tog_Search;
