...
void Display_Node_Stack::NewStack(int data)
{
    this->data = data;
...
void Display_Node_Stack::renderNode(RenderTarget* window)
{
    string s = to_string(data);
    text.setString(s);
...
void Display_Node_Stack::change(int sizeId, bool theme)
{
    //display part
    switch (sizeId)
    {
...
void Stack::AddDisplay(int v, int data)
{
    switch (type)
    {
        case isRound:
        {
            Display_Node_Stack newRound;
            newRound.NewStack(data);
...
void Stack::UpdateKth(int k, int data)
{
    if (Head == nullptr) return;
...
void Stack::render(RenderWindow* window)
{
    if (Head == nullptr) return;
...
void Stack::change(int sizeId, bool theme)
{
    switch (type)
    {
    case isRound:
