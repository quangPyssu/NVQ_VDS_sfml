...
Doubly_Linked_List_Menu::~Doubly_Linked_List_Menu()
{
	//Button
...
void Doubly_Linked_List_Menu::TimeTravel()
{
	//Render();
	//anime->drawOneStep(anime->curStep);
}

void Doubly_Linked_List_Menu::stop(float i)
{
...
void Doubly_Linked_List_Menu::update(const Vector2f mousePos)
{
