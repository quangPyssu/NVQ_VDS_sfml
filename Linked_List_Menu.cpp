...
Linked_List_Menu::Linked_List_Menu(Event* event, RenderWindow* window)
{
	...
	this->tog_Add = new ToggleButton(50, 90, 0, 0, 2, "Add", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),true ,  Color::Black);
	this->tog_Delete = new ToggleButton(50, 130, 0, 0, 2, "Delete", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),true ,  Color::Black);
	this->tog_Update = new ToggleButton(50, 170, 0, 0, 2, "Update", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),true ,  Color::Black);
	this->tog_Search = new ToggleButton(50, 210, 0, 0, 2, "Search", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),true ,  Color::Black);
	...
	{
		this->box_init_read = new TextBox(tog_Initialize->pos_x + 340, tog_Initialize->pos_y, 0, 0, 2, "Input Value", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), 200, 0, 50, Color::Black);
		this->box_init_fixed = new TextBox(tog_Initialize->pos_x + 240, tog_Initialize->pos_y, 0, 0, 2, "Input Size", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), 300, 0, 9, Color::Black);

		this->tog_init_empty = new ToggleButton(tog_Initialize->pos_x + 100, tog_Initialize->pos_y, 70, 0, 2, "Empty", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_init_random = new ToggleButton(tog_Initialize->pos_x + 170, tog_Initialize->pos_y, 70, 0, 2, "Random", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_init_fixed = new ToggleButton(tog_Initialize->pos_x + 240, tog_Initialize->pos_y, 100, 0, 2, "", Color::White, Color::Black, Color::Green, Color::Blue,false ,  Color::Black);
		this->tog_init_read = new ToggleButton(tog_Initialize->pos_x + 340, tog_Initialize->pos_y, 100, 0, 2, "", Color::White, Color::Black, Color::Green, Color::Blue,false ,  Color::Black);
		this->tog_init_load = new ToggleButton(tog_Initialize->pos_x + 440, tog_Initialize->pos_y, 70, 0, 2, "Load", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
	...
	{
		this->box_add_val = new TextBox(tog_Add->pos_x + 200, tog_Add->pos_y, 0, 0, 2, "Input Value", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), 120, 0, 9, Color::Black);
		...
		this->tog_add_head = new ToggleButton(box_add_pos->pos_x, box_add_pos->pos_y + 35, 100, 0, 0, "Head", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_add_tail = new ToggleButton(box_add_pos->pos_x, box_add_pos->pos_y + 65, 100, 0, 0, "Tail", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_add_pos  = new ToggleButton(box_add_pos->pos_x, box_add_pos->pos_y + 95, 100, 0, 0, "Input Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		...
		Toggle_Group_Add.tog_Grp_Head = new ToggleButton(tog_Add->pos_x + 100, tog_Add->pos_y , 100, 0, 2, "Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true,  Color::Black);
	}

	// make TextBox&btn for DEL;
	{
		this->btn_del_confirm = new Button(tog_Delete->pos_x + 220, tog_Delete->pos_y, 0, 0, "CONFIRM", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), Color::Black);
		...
		this->tog_del_head = new ToggleButton(box_del_pos->pos_x, box_del_pos->pos_y + 35, 100, 0, 0, "Head", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_del_tail = new ToggleButton(box_del_pos->pos_x, box_del_pos->pos_y + 65, 100, 0, 0, "Tail", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_del_pos = new ToggleButton(box_del_pos->pos_x, box_del_pos->pos_y  + 95, 100, 0, 0, "Input Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		...
		Toggle_Group_Del.tog_Grp_Head = new ToggleButton(tog_Delete->pos_x + 100, tog_Delete->pos_y, 100, 0, 2, "Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true,  Color::Black);
	}

	// make TextBox&btn for UPDATE;
	{
		this->box_upd_val = new TextBox(tog_Update->pos_x + 200, tog_Update->pos_y, 0, 0, 2, "Input Value", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), 120, 0, 9, Color::Black);
		...
		this->tog_upd_head = new ToggleButton(box_upd_pos->pos_x, box_upd_pos->pos_y + 35, 100, 0, 0, "Head", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_upd_tail = new ToggleButton(box_upd_pos->pos_x, box_upd_pos->pos_y + 65, 100, 0, 0, "Tail", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		this->tog_upd_pos = new ToggleButton(box_upd_pos->pos_x, box_upd_pos->pos_y + 95, 100, 0, 0, "Input Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255),false ,  Color::Black);
		...
		Toggle_Group_Upd.tog_Grp_Head = new ToggleButton(tog_Update->pos_x + 100, tog_Update->pos_y, 100, 0, 2, "Position", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true,  Color::Black);
	}

	// make TextBox&btn for SEARCH;
	{
		this->box_ser_val = new TextBox(tog_Search->pos_x + 100, tog_Search->pos_y, 0, 0, 2, "Input Value", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), 120, 0, 9, Color::Black);
	}
	
	// make btn for Time travel;

	this->tog_play = new ToggleButton(840, 130, 0, 0, 2, "Play", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true, Color::Black);
	this->btn_step_prev = new Button(800, 90, 0, 0, "Step Back", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), Color::Black);
	this->btn_step_next = new Button(880, 90, 0, 0, "Step Forward", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), Color::Black);
	this->tog_speed = new ToggleButton(840, 50, 0, 0, 2, "Slow Speed", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true,  Color::Black);
...
void Linked_List_Menu::TimeTravel()
{
	//Render();
