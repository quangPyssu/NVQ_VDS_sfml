...
Linked_List_Menu::Linked_List_Menu(Event* event, RenderWindow* window)
{
	...
	this->tog_speed = new ToggleButton(1100, 100, 0, 0, 2, "Slow Speed", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true, Color::Black);
	this->tog_play = new ToggleButton(1100, tog_speed->pos_y + tog_speed->size_y * 2 + 6 + 20, 0, 0, 2, "Play", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), true, Color::Black);
	this->btn_step_prev = new Button(1100 - tog_speed->size_x / 2 - 10, tog_speed->pos_y + tog_speed->size_y + 4 + 10, 0, 0, "Step Back", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), Color::Black);
	this->btn_step_next = new Button(1100 + tog_speed->size_x / 2 + 10, tog_speed->pos_y + tog_speed->size_y + 4 + 10, 0, 0, "Step Forward", Color::Black, Color::White, Color::Color(90, 90, 90, 155), Color::Color(90, 90, 90, 255), Color::Black);
...
void Linked_List_Menu::drawTrans(int start,int end,short CodeStatus)
{
	float StepTime = 0.5;
	float frame = 20;
	...
	{
		Render();
		anime->drawSmoothTransition(start, end, j * 0.1, CodeStatus);
		stop(FrameTime);
	}
	isDrawing = DrawStep;
}

void Linked_List_Menu::drawFrom(int Current,bool hasHead)
{
...
void Linked_List_Menu::Render()
{
	...
	if (isDrawing == DrawNormal) l.render(window); else
		if (isDrawing == DrawStep) anime->drawOneStep(anime->curStep), anime->drawFakeCode(anime->curStep, 0);
}
