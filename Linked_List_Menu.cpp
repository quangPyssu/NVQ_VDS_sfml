...
Linked_List_Menu::Linked_List_Menu(Event* event, RenderWindow* window)
{
	...
	// Instruction
	{
		...
		Instruction[0] = "Make an Empty Singly Linked List";
		Instruction[1] = "Make an Singly Linked List with random size and values";
		Instruction[2] = "Make an Singly Linked List with inputed size and values";
		Instruction[3] = "Make an Singly Linked List with inputed values (for creating a LinkedList with size 1 please use ADD function)";
		Instruction[4] = "Make an Singly Linked List with size and value imported from data file";
...
void Linked_List_Menu::loadInstruction()
{
